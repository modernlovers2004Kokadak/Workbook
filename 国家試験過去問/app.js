...
function pastHome(){location.replace('../index.html')}
...
function pastBack(){if(state.screen==='quiz')saveSession();if(state.screen!=='home'){state.screen='home';state.index=0;state.answers=[];state.revealed=false;render();scrollTo(0,0);commitPastNavigation(true);return}pastHome()}
